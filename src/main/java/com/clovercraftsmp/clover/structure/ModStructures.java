...
public class ModStructures {
    public static final List<StructureEntry> ALL = List.of(
            ...
            new StructureEntry("campsite", BiomeTags.IS_FOREST, TerrainAdjustment.BEARD_THIN, 24, 6, 4205),
            new StructureEntry("desertarch", BiomeTags.IS_FOREST, TerrainAdjustment.BEARD_THIN, 24, 6, 4206),
            new StructureEntry("deserthouse", BiomeTags.IS_FOREST, TerrainAdjustment.BEARD_THIN, 24, 6, 4207),
            ...
            new StructureEntry("wizardtower", BiomeTags.IS_FOREST, TerrainAdjustment.BEARD_THIN, 24, 6, 4214)
    );
}
